...
const projectData = {
    project1: {
        ...
        overview: {
            ...
            content: `
                FrogHire.ai is a job-search tool built for international students and professionals pursuing work in the U.S. under strict visa conditions. With a growing user base and a promising dataset, the product offered real utility—but lacked the design infrastructure to support its long-term vision.
                <br><br>
        ...
        execution: {
            title: 'Execution',
            content: [
                '<strong>Sidebar Redesign:</strong> Replaced the legacy floating modal. This new UI anchors search strategy, streamlines filter inputs, and supports feature growth—while dramatically improving visibility and control.',
        ...
        challenges: {
            ...
            content: [
                ...
                <p><strong>🛠 Solution:</strong> Integrated visual onboarding cues, status indicators, and in-context tooltips to surface critical functionality.</p>`,
                ...
                <p><strong>🛠 Solution:</strong> Introduced a fixed sidebar that kept strategy controls persistently visible while offering better spatial hierarchy and fewer clicks.</p>`,
                ...
                <p><strong>🛠 Solution:</strong> I designed compatibility indicators and clear platform icons alongside filters, improving transparency and trust.</p>`
            ],
            images: [
        ...
        outcomes: {
            ...
            content: [
                '🚀 +10,000 new users acquired in 5 months',
                '📊 23% improvement in user satisfaction scores (via post-session surveys and analytic benchmarks)',
                '🎨 Successful relaunch with unified branding and streamlined experience across the Chrome extension and web platform'
            ],
            images: [
        ...
        reflection: {
            title: 'Reflection',
            content: `This project deepened my ability to translate qualitative feedback and usage data into intuitive product systems. I learned that meaningful UX isn't just about clean layouts—it's about designing trust, reducing ambiguity, and aligning with the emotional stakes of real users. FrogHire became more than a filter—it became a guide.`
        },
        images: [
    ...
    project2: {
        ...
        challenges: {
            ...
            content: [
                ...
                <p><strong>🛠 Solution:</strong> Created digestible, story-driven content pillars focused on user benefits.</p>`,
                `<p><strong>Low Early Engagement</strong> Initial posts struggled due to technical jargon.</p>
                <p><strong>🛠 Solution:</strong> Introduced user stories and relatable analogies to humanize the technology.</p>`,
                `<p><strong>Cross-Platform Consistency</strong> Maintaining voice across channels was challenging.</p>
                <p><strong>🛠 Solution:</strong> Developed a comprehensive style guide and content calendar.</p>`
            ]
        },
        outcomes: {
            title: 'Outcomes & Impact',
            content: [
                '📢 Grew social media engagement by 200% with new messaging',
                '🌍 Attracted 1,000+ new followers through educational, themed content',
                '💬 Messaging adopted across pitch decks and internal communication'
            ],
            images: [
        ...
        reflection: {
            title: 'Reflection',
            content: `Aloega taught me how to write for deep-tech products without losing humanity. I learned to balance educational content with emotional resonance—and how to adapt tone for diverse audiences across the healthcare x blockchain frontier.
            <br><br>
            This was a project about clarity, trust, and mission-driven storytelling—exactly the type of work I want to keep doing.`
        },
        images: [
    ...
    project3: {
        ...
        challenges: {
            ...
            content: [
                ...
                <p><strong>🛠 Solution:</strong> Implemented clear visual hierarchy and intuitive transitions.</p>`,
                `<p><strong>Content Overload</strong> Key pages were dense and hard to scan.</p>
                <p><strong>🛠 Solution:</strong> Reorganized content with improved spacing and typography.</p>`,
                `<p><strong>Mobile Responsiveness</strong> Site performed poorly on mobile devices.</p>
                <p><strong>🛠 Solution:</strong> Developed mobile-first layouts and optimized images.</p>`
            ]
        },
        outcomes: {
            title: 'Outcomes & Impact',
            content: [
                '✨ Improved clarity in navigation based on usability feedback',
                '🛍️ More brand cohesion between visuals and product exploration',
    ...
    sections.forEach(section => {
        if (project[section]) {
            ...
            if (sectionEl) {
                ...
                // ★ special‐case execution: build 2×2 grid with image holders
                ...
                // media gallery for non‐execution sections
                if (section !== 'execution') {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Back‑to‑top functionality (now inside DOMContentLoaded)
